...
export function AdapterLogo({ adapter, className }: AdapterLogoProps): JSX.Element {
  const title = adapter === 'claude' ? 'Claude Code logo' : 'Codex logo';
  ...
  return (
    ...
    >
      <title>{title}</title>
      <path clipRule="evenodd" d={adapter === 'claude' ? CLAUDE_CODE_PATH : CODEX_PATH} />
    </svg>
  );
}
